(function () {
    ...
    function layoutCtrl(snapLightboxService,$rootScope,$http,$state,$localStorage,$window){
        ...
        vm.logout = logout;
        vm.saveGlobalSearchConditions = saveGlobalSearchConditions
        function init(){
            vm.registerObj = {};
            vm.isUser = false;
            vm.openSearchSection = false;
            vm.globalSearchConditions = {};
            vm.isCertified();
        }
        ...
        function saveGlobalSearchConditions() {
            vm.openSearchSection = false;
            console.log(vm.globalSearchConditions);
        }
    }
})()